...
/// Type-erased version of the instance of some type conforming to the `Codable`
/// protocol.
///
/// ## Limitations
///
/// Because this implementation is specific to Pragma and its use cases, not all
/// codables can have their type erased. In fact, due to the ID of every
/// implementation of plan, goal and to-do being a UUID, that is the only
/// supported type; an instance of any other codable being wrapped by this
    ...
    default:
      throw EncodingError.invalidValue(
        ...
        .init(
          ...
          debugDescription:
            "Encoding of type-erased \(erasedType) (\(base)) is unsupported."
        )
      )
    }
  }
