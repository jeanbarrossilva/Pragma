...
/// call ``copy()`` on the snapshot and receive an instance *in that same state*, guaranteed to not
/// have been referenced by any other context prior to that call — not even by the snapshot itself.
